...
function AdminProductFund() {
  ...
  const addProduct = async (e) => {
    ...
    if(!product || !price || !quantity ||!date){
      ...
      try {
        await addDoc(collection(db, 'productfunds'), formData);
  ...
  const getProductFunds = async () => {
    try {
      const data = await getDocs(collection(db, 'productfunds'));
...
export default AdminProductFund;
