...
function EshPatient() {
  ...
  const registerPatient = async (e) => {
    ...
    try {
      ...
      console.log(error)
      toast.error("Failed to save ESH patient")
    }
  }
        ...
        <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-sm border border-slate-100">
          <div className="flex items-center justify-between mb-10">
            ...
            <div className="text-center flex-1">
              ...
              <p className="text-slate-500 font-medium text-sm">Create a new entry in the ESH clinical database</p>
            </div>
          ...
          <form className='space-y-8' onSubmit={registerPatient}>
            ...
            <div className="space-y-6">
              ...
              >
                Create ESH Record <AiOutlineArrowRight />
              </button>
            </div>
          </form>
        </div>
