      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          <div className="space-y-1">
            <h1 className="text-2xl font-bold text-slate-900">Admin - Patients Directory</h1>
            <p className="text-slate-500 font-medium">
              Total Records: <span className="text-[#FF5162]">{patients.length}</span>
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="relative w-full sm:w-80">
              <input
                type="text"
                placeholder="Search by Name, Condition, Gender..."
                value={searchQuery}
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                <div className={`flex-shrink-0 w-16 h-16 rounded-2xl flex items-center justify-center text-2xl font-bold shadow-inner ${
                  ...
                  data.selectedValue === "Home-Patient-Admin" ? "bg-amber-50 text-amber-600" :
              ...
              <button
                ...
                className={`w-full py-3 rounded-xl text-white font-bold text-sm transition-all shadow-md active:scale-95 ${
                  ...
                  data.selectedValue === "Home-Patient-Admin" ? "bg-amber-500 hover:bg-amber-600 shadow-amber-100" :
