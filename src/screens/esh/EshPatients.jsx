    ...
    <>
      ...
      <div className="px-4 md:px-8 lg:px-8 h-full mx-auto my-5 relative">
        <div className="flex justify-between items-center">
          <div>
            <p className="   justify-center md:text-lg font-bold">
              <span className="hidden md:block">List of Patients: </span>
              <span className="text-green-500">{patients.length}</span>
            </p>
          </div>
          <div className="sort flex gap-6 space-x-4 px-4 justify-between items-center">
            ...
            >
              <BsSortAlphaDown size={24} color="blue" />
              <span className="hidden md:block">Alphabetical Order</span>
            </button>
            <button
              className="flex text-xs gap-x-3 items-center"
              onClick={() => toggleSortBy("date")}
            >
              <BsFillCalendarDateFill size={24} color={"green"} />{" "}
              <span className="hidden md:block">Date Added</span>{" "}
            </button>
            <button
              className="flex text-xs gap-x-3 items-center"
              onClick={() => toggleSortBy("update")}
            >
        ...
        <div className="flex gap-2 my-4">
          <button
            ...
            className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-all ${
              genderFilter === "All"
                ? "bg-[#FF5162] text-white shadow-md"
                : "bg-white text-gray-600 border border-gray-300 hover:border-[#FF5162]"
            }`}
          >
            All
          </button>
          ...
          <button
            ...
            className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-all ${
              genderFilter === "Female"
                ...
                : "bg-white text-gray-600 border border-gray-300 hover:border-pink-500"
            }`}
          >
            Female
          </button>
