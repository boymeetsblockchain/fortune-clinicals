...
function EshProductsFund() {
  ...
  const filteredEshProductsFund = data?.filter((product) =>
      ...
      <Input
        ...
        <div className="mt-4 ">
          <table className="min-w-full border border-collapse border-gray-200">
            ...
            <tbody>
              {filteredEshProductsFund.map((item) => (
...
export default EshProductsFund;
